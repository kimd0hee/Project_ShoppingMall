...
<body>
<h1 style="font-size:35px;">회원등록</h1>
	<form name="form1" method="post" action="${path }/userInsert.do">
		...
		<table class="table table-bordered m-0">
			...
			<tr class="member" class="phone">
            	...
            	<input class="col-md-2" id="phone1" type="text" name="user_phone" maxlength="3" oninput="changePhone1()" style="height:35px; border-radius:7px;"> -
            	<input id="phone2" type="text" name="user_phone" maxlength="4" oninput="changePhone2()" style="height:35px; border-radius:7px;"> -
            	<input id="phone3" type="text" name="user_phone" maxlength="4" oninput="changePhone3()" style="height:35px; border-radius:7px;"></td>
        	</tr>
